...
```{r cleaning, echo=TRUE, cache = FALSE, message=FALSE,warning=FALSE}
...
```{r plotfeatures, echo=TRUE, cache = FALSE, message=FALSE,warning=FALSE}
...
```{r datainfo, echo=TRUE, cache = FALSE}
flag_PCA = FALSE
if (flag_PCA){
...
```{r rpart, echo=TRUE, cache = FALSE, message=FALSE,warning=FALSE}
...
```{r rf, echo=TRUE, cache = FALSE, message=FALSE,warning=FALSE}
